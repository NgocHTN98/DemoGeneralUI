...
//            lblValue.font = UIFont(name: "Inter-Medium", size: 14)
...
//            lblValue.font = UIFont(name: "Inter-SemiBold", size: 16)
//        case .text:
...
//        btnEdit.titleLabel?.font = UIFont(name: "Inter-Medium", size: 14)
...
//        lblKey.font = UIFont(name: "Inter-Regular", size: 14)
//        lblValue.textColor = UIColor(red: 0.157, green: 0.157, blue: 0.157, alpha: 1)
//        lblValue.font = UIFont(name: "Inter-Medium", size: 14)
//
//        lineView.backgroundColor = UIColor(hexString: "#DCE5FF")
//
//
